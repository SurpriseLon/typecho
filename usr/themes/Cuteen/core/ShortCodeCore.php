...
function shortcode_atts($pairs, $atts): array
{
	$atts = (array)$atts;
	$out = array();
...
function get_shortcode_regex($tagnames = null): string
{
	global $shortcode_tags;
	if (empty($tagnames)) {
...
function do_shortcodes_in_html_tags($content, $ignore_html, $tagnames): string
{
...
function kses_one_attr($string, $element): string
{
